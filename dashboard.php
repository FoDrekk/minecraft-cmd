...
<div class="dash-layout">
  ...
  <div class="dash-hero">
    <div class="dash-hero-left">
      ...
      <p>// every tool in one place · Java Edition 1.20+</p>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body" style="padding:12px">
        ...
        <div style="text-align:center;padding:20px;color:var(--text3);font-size:12px;font-family:var(--mono);line-height:2">
          📭 No history yet.<br>Pergi ke Command Generator to get started.
        </div>
        <?php else: ?>
    ...
    <div class="card">
      ...
      <div class="card-body" style="padding:16px">
        <p style="font-size:12px;color:var(--text3);font-family:var(--mono);margin-bottom:14px;line-height:1.7">
          Export your saved commands as a .txt or .mcfunction file to use in a Minecraft data pack.
        </p>
        ...
        <div style="background:rgba(91,156,246,0.05);border:1px solid rgba(91,156,246,0.15);border-radius:8px;padding:10px 12px">
          <p style="font-size:11px;color:var(--text3);font-family:var(--mono);line-height:1.8">
            💡 .mcfunction — put it in <code style="color:var(--blue)">data/&lt;namespace&gt;/functions/</code><br>
...
async function exportCommands(type) {
  try {
    ...
    if (type === 'favtxt') {
      ...
      if (!commands.length) { showToast('⚠️ Nothing saved to export.', 'var(--red)'); return; }
      ...
      if (!commands.length) { showToast('⚠️ No history to export.', 'var(--red)'); return; }
